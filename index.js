    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                jsonData = fs.readFileSync('abi.json', 'utf-8');
                uniswapABI = JSON.parse(jsonData).abi;
                provider = ethers_1.ethers.getDefaultProvider('homestead');
                uniswapContract = new ethers_1.ethers.Contract(uniswapAddress, uniswapABI, provider);
                return [4 /*yield*/, uniswapContract.getAmountsOut(FROM_BALANCE, [FROM_TOKEN.address, TO_TOKEN.address])];
            case 1:
            ...
            case 2:
                ...
                return [4 /*yield*/, coingeckoResponse.json()];
            case 3:
