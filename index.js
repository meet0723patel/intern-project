...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    var uniswapAddress, jsonData, uniswapABI, swapBalance, slippagePercent;
    return __generator(this, function (_a) {
        console.info("Converting ".concat(FROM_BALANCE.toString(), " ").concat(FROM_TOKEN.symbol, " to ").concat(TO_TOKEN.symbol));
        console.info('HELLO WORLD');
        uniswapAddress = "0x5C69bEe701ef814a2B6a3EDD4B1652CB9cc5aA6f";
        jsonData = fs.readFileSync('abi.json', 'utf-8');
        uniswapABI = JSON.parse(jsonData);
